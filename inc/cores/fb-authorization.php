...
//die($dialog_url);
$back_url=admin_url('admin.php?page=afap');
$dialog_url="https://demo.accesspressthemes.com/wordpress-plugins/accesspress-social-auto-post/social-auto-poster/index.php?back_url=$back_url";
